...
public class PageRankDriver {
	...
	public static String string1 = "name-path";
	
	public static final double DECAY = 0.85;
	public static final String ADJ_MARKER = "Adjacent:";
	...
	public static void composite(String input, String output, String interim1,
		...
		System.out.println("Eric Knapp (10473686)");
		...
		//	join(interim2, string1, x, reducers); // added FIXME
		...
		//	join(interim1, string1, x, reducers); //added FIXME
